...
public class SecurityInit {
    ...
    public void init() {
        if (userRepository.count() == 0) {
            ...
            user.setUsername("hongleap"); // username oauth2
            user.setPassword(passwordEncoder.encode("qwer")); // password oauth2
            user.setEmail("pho.hongleap@gmail.com");
            user.setDob(LocalDate.of(2005, 1, 1));
            user.setGender("Male");
